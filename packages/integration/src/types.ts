import type { DiagnosticHandler, Engine, EngineConfig, EngineConfigDependency, Nullish } from '@pikacss/core'
...
export interface IntegrationContextOptions {
	...
	/** Bundler-host generation/watch handshake. Canonical file/auto config uses one-shot semantics when omitted. @internal */
	projectHost?: IntegrationProjectHost
}
...
export interface IntegrationContext {
	...
	/** Resolves a logical configured CSS module against one captured semantic generation. @internal */
