...
type EngineHooksDefinition<
	...
	_StyleItem,
> = DefineHooks<{
	config: ['async', EngineConfig<EnginePlugin[], _Selector, _CSSProperty, _Properties, _StyleDefinition, _StyleItem> & _CustomConfig]
	beforeConfigResolving: ['sync', EngineConfig<EnginePlugin[], _Selector, _CSSProperty, _Properties, _StyleDefinition, _StyleItem> & _CustomConfig, void]
