...
type EngineHooksDefinition<
	...
	_StyleItem,
> = DefineHooks<{
	config: ['async', EngineConfig<EnginePlugin[], _CustomConfig, _Properties, _StyleDefinition, _StyleItem>]
	beforeConfigResolving: ['sync', EngineConfig<EnginePlugin[], _CustomConfig, _Properties, _StyleDefinition, _StyleItem>, void]
...
export interface EnginePlugin<
	_CustomConfig extends Record<string, any> = Record<string, any>,
